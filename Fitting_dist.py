...
from functions import evaluate_estimator, piecewise_linear
...
#%%
piecewise_estimator = piecewise_linear(quantiles, actual.min(), actual.max())
pseudo, resids = piecewise_estimator.transform(estimated_quantiles.values, actual.values)

#%%
evaluate_estimator(actual, estimated_quantiles, piecewise_estimator)
...
ar_mod = sm.tsa.SARIMAX(resids, order = (1,0,1))
res = ar_mod.fit()
